        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="Huo[name]" class="form-control" id=""
                               value="@if($huodong->name){{$huodong->name}}@else{{old('Huo')['name']}}@endif"
                               placeholder="请输入活动名称">
                    </div>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name='Huo[username]' class="form-control" id="doorno"
                               value="@if($huodong->username){{$huodong->username}}@else{{old('Huo')['username']}}@endif"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name='Huo[phone]' class="form-control" id=""
                               value="@if($huodong->phone){{$huodong->phone}}@else{{old('Huo')['phone']}}@endif"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="datainp" id="open_time" name='Huo[open_time]' value="{{date('Y-m-d',$huodong->open_time)}}" type="text" placeholder="请选择" readonly>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input class="datainp" id="close_time" name='Huo[close_time]' value="{{date('Y-m-d',$huodong->close_time)}}" type="text" placeholder="请选择" readonly>
                    </div>
                    <div class="col-sm-5">
             ...
             <textarea name='Huo[intro]' id="intro" class="form-control">@if($huodong->intro){{$huodong->intro}}@else{{old('Huo')['intro']}}@endif</textarea>
                    </div>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                              <textarea name='Huo[info]' id='info' class="form-control" rows="20">@if($huodong->info){{$huodong->info}}@else{{old('Huo')['info']}}@endif</textarea>
                    </div>
                    <div class="col-sm-5">
